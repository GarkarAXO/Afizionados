...
export default function ArenaAllProductsPage() {
  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-8 py-12 transition-colors duration-300">
      ...
      <div className="mb-12">
        <h1 className="text-3xl sm:text-5xl font-black uppercase tracking-tight mb-4 text-gray-900 dark:text-white">Catálogo de Gemas</h1>
        <p className="text-gray-500 dark:text-gray-400 text-sm sm:text-base font-medium max-w-2xl leading-relaxed">
          Explora nuestra colección completa de memorabilia. Navega por las bibliotecas de la Arena para encontrar la próxima gema de tu colección.
        </p>
      </div>
      ...
      <div className="flex flex-col lg:flex-row gap-12">
        ...
        <aside className="w-full lg:w-64 space-y-8">
          <div>
            <h3 className="text-[10px] font-black uppercase tracking-[0.2em] text-[#d4af35] mb-6">Explorar Colecciones</h3>
          ...
          <div className="hidden lg:block p-6 bg-gray-50 dark:bg-[#1a170e] rounded-2xl border border-gray-200 dark:border-[#d4af35]/10">
            <span className="material-symbols-outlined text-[#d4af35] mb-4">verified_user</span>
            <h4 className="text-xs font-black uppercase mb-2 text-gray-900 dark:text-white">Peritaje Experto</h4>
            <p className="text-[10px] text-gray-500 leading-relaxed font-bold uppercase tracking-tight">La Arena garantiza la legitimidad mediante certificados físicos y digitales.</p>
          </div>
        </aside>
        ...
        <div className="flex-1">
          {loading ? (
            ...
            <div className="py-20 text-center bg-gray-50 dark:bg-white/5 rounded-3xl border border-dashed border-gray-200 dark:border-white/10">
              ...
              <p className="text-gray-500 font-black uppercase text-[10px] tracking-widest">Sin resultados para esta selección</p>
            </div>
          ) : (
              ...
              {filteredProducts.map((product) => (
                <div key={product.id} className="group relative">
                  <div className="relative aspect-[4/5] bg-gray-100 dark:bg-[#1a170e] rounded-2xl border border-gray-200 dark:border-white/5 overflow-hidden transition-all duration-500 group-hover:border-[#d4af35]/30">
                    ...
                    <div className="absolute inset-0 bg-black/60 opacity-0 group-hover:opacity-100 transition-opacity duration-500 flex flex-col items-center justify-center gap-3 p-6 text-white">
                  ...
                  <div className="mt-4 space-y-1">
                    <p className="text-[9px] text-[#d4af35] font-black uppercase tracking-widest">Catálogo</p>
