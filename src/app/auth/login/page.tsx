...
export default function LoginPage() {
  ...
  const handleLogin = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (data.success) {
        // Mostramos la bienvenida primero, SIN guardar nada en localStorage aún
        setUserName(data.data.user.name || 'Coleccionista');
        setIsSuccess(true);
        
        // Esperamos 3 segundos antes de guardar y redirigir
        setTimeout(() => {
          ...
          <div className="w-full md:w-1/2 p-6 sm:p-8 lg:p-12 flex flex-col justify-center relative">
            ...
            <div className="mt-8 text-center">
              <p className="text-[10px] font-bold text-gray-500 dark:text-gray-400 uppercase tracking-widest">
                ...
                <Link href="/auth/register" className="font-black text-[#d4af35] hover:underline underline-offset-4 ml-2">
                  Crear una Cuenta
                </Link>
              </p>
            </div>
